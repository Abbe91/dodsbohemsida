...
const Bortforslingdodsboboras = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle:
      "Effektiv bortforsling av dödsbo i Borås - Vi tar hand om allt från sortering och packning till avfallshantering och återvinning för att ge dig en smidig och stressfri process. Låt oss sköta bortforslingen av ert dödsbo i Borås | Dödsbo Jouren",
    metaContent:
