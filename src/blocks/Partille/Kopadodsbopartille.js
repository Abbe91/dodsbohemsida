...
const Kopadodsbopartille = ({ videoText }) => {
  ...
  const mainquery = "Köpa dödsbo Partille";
  const newsData = useSelector(getNewsData);
  const bingNews = useSelector(getBingNews);
  const [content, setContent] = useState({
    metaTitle: "Köpa dödsbo Partille",
    metaContent: "Köpa dödsbo Partille",
    query: "Köpa dödsbo Partille",
    formTitle: "Köpa dödsbo Partille",
    subTitle2:
