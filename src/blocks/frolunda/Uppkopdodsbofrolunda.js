...
const Uppkopdodsbofrolunda = ({ videoText }) => {
  ...
  const mainquery = "uppköp dödsbo Frölunda";
  const newsData = useSelector(getNewsData);
  const bingNews = useSelector(getBingNews);
  const [content, setContent] = useState({
    metaTitle:
      "Uppköp dödsbo Frölunda. Din auktoriserade hanterare av dödsbo, bohag, försäljning, tömning, bortforsling, sanering, flytt, städning och uppköp av dödsbo i Frölunda",
    metaContent:
      "Uppköp dödsbo Frölunda. Din auktoriserade hanterare av dödsbo, bohag, försäljning, tömning, bortforsling, sanering, flytt, städning och uppköp av dödsbo i Frölunda",
    query: "Uppköp dödsbo Frölunda",
    formTitle: "Uppköp dödsbo Frölunda",
    subTitle2:
