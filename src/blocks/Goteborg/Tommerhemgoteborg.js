...
const Tommerhemgoteborg = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle:
      "Vi tömmer, flyttar och städar hem, förråd, hus, lägenheter i Göteborg. Dödsbo Jouren tar hand om hela hem och även delar av hem om någon flyttat till ett serviceboende eller liknade.",
    metaContent:
