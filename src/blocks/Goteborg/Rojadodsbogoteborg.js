...
const Rojadodsbogoteborg = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle: "Röja dödsbo Göteborg",
    metaContent: "Röja dödsbo Göteborg",
    query: "Röja dödsbo Göteborg",
    formTitle: "Röja dödsbo Göteborg",
    subTitle2:
      "Din auktoriserade dödsbo hanterare av dödsbo, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt och städ i Göteborg",
    subTitle3: `Behöver du professionell hjälp med ${mainquery}`
  });
  const customerData = useSelector(getCustomerData);

  const services =
    "uppköp, tömning, röja, bortforsling, sanering, luktsanering, flytt, städ, försäljning av dödsbo och bohag";
