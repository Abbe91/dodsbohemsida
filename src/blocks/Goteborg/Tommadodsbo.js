...
const Tommadodsbo = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle:
      "Tömma dödsbo. Din auktoriserade hanterare av dödsbo, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt, städning och tömning av dödsbo i Göteborg",
    metaContent:
      "Tömma dödsbo. Din auktoriserade hanterare av dödsbo, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt, städning och tömning av dödsbo i Göteborg",
    query: "Tömma dödsbo",
  ...
  const services =
    "uppköp, tömning, bortforsling, sanering, luktsanering, flytt, städ, försäljning och tömning av dödsbo i Göteborgg";
