...
const Flyttfirmagoteborg = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle:
      "Flyttfirma Göteborg. Din auktoriserade flyttfirma i Göteborg. Vi utför flyttar av lägenheter, flyttar av hus och kontorsflytt i Göteborg. Vi forslar bort och tömmer även hus, lägenheter och kontor",
    metaContent:
      "Flyttfirma Göteborg. Din auktoriserade flyttfirma i Göteborg. Vi utför flyttar av lägenheter, flyttar av hus och kontorsflytt i Göteborg. Vi forslar bort och tömmer även hus, lägenheter och kontor",
