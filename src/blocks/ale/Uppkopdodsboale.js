...
const Uppkopdodsboale = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle: "Uppköp dödsbo Ale",
    metaContent: "Uppköp dödsbo Ale",
    query: "Uppköp dödsbo Ale",
    formTitle: "Uppköp dödsbo Ale",
    subTitle2:
      "Din auktoriserade dödsbo hanterare av dödsbo, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt och städ i Ale",
