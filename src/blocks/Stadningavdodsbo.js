...
const Stadningavdodsbo = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle: "Städning av dödsbo",
    metaContent: "Städning av dödsbo",
    query: "Städning av dödsbo",
    formTitle: "Städning av dödsbo",
    subTitle2:
      "Din auktoriserade dödsbo hanterare av dödsbo, bohag, uppköp, försäljning, tömning, bortforsling, sanering, flytt och städning av dödsbo",
