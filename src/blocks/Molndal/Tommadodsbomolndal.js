...
const Tommadodsbomolndal = ({ videoText }) => {
  ...
  const [content, setContent] = useState({
    metaTitle:
      "Tömma dödsbo Mölndal. Din auktoriserade hanterare av dödsbo, bohag, uppköp, försäljning, bortforsling, sanering, flytt, städning och tömning av dödsbo i Mölndal",
    metaContent:
      "Tömma dödsbo Mölndal. Din auktoriserade hanterare av dödsbo, bohag, uppköp, försäljning, bortforsling, sanering, flytt, städning och tömning av dödsbo i Mölndal",
